    ...
    $(document).ready(function () {
        ...
        let new_input = '<div><input type="text"  class="form-control-lg" id="lesson_name" name="total_lesson[]"  value=""><a href="javascript:void(0);" class="remove-input" title="remove input"><img src="/static/img/minus.png" type="button" class="btn-outline-light"></a></div> '
        let add_count = 1;
